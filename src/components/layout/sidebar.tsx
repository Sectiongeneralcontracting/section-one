...
import { LayoutDashboard, Briefcase, Users, HandCoins, Settings, UserCog, FileBarChart, FileSignature, Truck, ShoppingCart, Warehouse, HardHat, IdCard, Wallet, CalendarCheck, ChevronDown, Users2 } from "lucide-react";
  ...
  return (
    <aside className="w-64 shrink-0 bg-steel-dark text-white min-h-screen p-4 hidden md:block overflow-y-auto">
      ...
      <nav className="space-y-1">
        ...
        >
          <Users2 size={18} />
          <span className="flex-1 text-right">{locale === "en" ? "HR Management" : "إدارة الموارد البشرية"}</span>
